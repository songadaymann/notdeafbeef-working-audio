...
_fm_voice_process:
    // MINIMAL TEST: Do absolutely nothing, just return
    ret
...
.Lloop:
    ...
    // Oracle's fix: Scale down FM output to match other voices (-20dB)
    ldr     w7, =0x3DCCCCCD     // 0.1 in hex
    fmov    s31, w7             // s31 = 0.1 (≈-20dB reduction)  
    fmul    s5, s5, s31         // s5 = reduced_fm_sample
    b       .Loutput
